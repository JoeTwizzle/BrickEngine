...
namespace BinSerialize
{
    ...
    public static unsafe partial class BinarySerializer
    {
        ...
        /// </summary>
        /// <remarks>
        /// See <see cref="WritePackedUInt"/> for more information.
        /// </remarks>
        /// <param name="span">Span to read from.</param>
        /// <returns>Unpacked unsigned integer.</returns>
        public static uint ReadPackedUInt(ref ReadOnlySpan<byte> span)
        {
        ...
        /// </summary>
        /// <remarks>
        /// See <see cref="WritePackedInt"/> for more information (including a size-table).
        /// </remarks>
        /// <param name="value">Value to check.</param>
        /// <returns>Number of bytes it will take.</returns>
        public static int GetSizeForPackedInt(int value)
        {
            var zigzagged = ToZigZagEncoding(value);
            return GetSizeForPackedUInt(zigzagged);
        }
        ...
        /// </summary>
        /// <remarks>
        /// See <see cref="WritePackedUInt"/> for more information (including a size-table).
        /// </remarks>
        /// <param name="value">Value to check.</param>
        /// <returns>Number of bytes it will take.</returns>
        public static int GetSizeForPackedUInt(uint value)
        {
        ...
        public static int WritePackedInt(ref Span<byte> span, int value)
        {
            var zigzagged = ToZigZagEncoding(value);
            return WritePackedUInt(ref span, zigzagged);
        }
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="value">Value to pack and write.</param>
        public static int WritePackedUInt(ref Span<byte> span, uint value)
        {
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteByte(ref Span<byte> span, byte val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteSByte(ref Span<byte> span, sbyte val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteShort(ref Span<byte> span, short val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteUShort(ref Span<byte> span, ushort val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteInt(ref Span<byte> span, int val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteUInt(ref Span<byte> span, uint val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteLong(ref Span<byte> span, long val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteULong(ref Span<byte> span, ulong val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteFloat(ref Span<byte> span, float val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteDouble(ref Span<byte> span, double val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteGuid(ref Span<byte> span, Guid val)
        {
            MemoryMarshal.Write(span, ref val);
        ...
        public static int Write8BitRange(ref Span<byte> span, float min, float max, float val)
        {
        ...
        /// <param name="max">Maximum value of the range.</param>
        /// <param name="val">Value to write (within the range.</param>
        public static int Write16BitRange(ref Span<byte> span, float min, float max, float val)
        {
            // Get a 0f - 1f fraction.
            var frac = Fraction(min, max, val);
        ...
        public static int WriteBlock(ref Span<byte> span, ReadOnlySpan<byte> val)
        {
            val.CopyTo(span);
        ...
        {
            var headerSize = GetSizeForPackedUInt((uint)charCount);
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteString(ref Span<byte> span, string val)
        {
            fixed (char* charPointer = val)
            {
                return WriteString(ref span, charPointer, val.Length);
            }
        }
        ...
        /// <param name="span">Span to write to.</param>
        /// <param name="val">Value to write.</param>
        public static int WriteString(ref Span<byte> span, ReadOnlySpan<char> val)
        {
            fixed (char* charPointer = val)
            {
                return WriteString(ref span, charPointer, val.Length);
        ...
        /// <param name="charPointer">Pointer to the first character.</param>
        /// <param name="charPointer">How many characters are in the string.</param>
        public static int WriteString(ref Span<byte> span, char* charPointer, int charCount)
        {
            // Write amount of bytes will follow.
            var byteCount = uft8.GetByteCount(charPointer, charCount);
            int headerSize = WritePackedUInt(ref span, (uint)byteCount);
        ...
        /// <param name="span">Span to read from.</param>
        /// <returns>Read value.</returns>
        public static Guid ReadGuid(ref ReadOnlySpan<byte> span)
        {
            var result = new Guid(span);
        ...
        {
            // Read a byte.
            var raw = BinarySerializer.ReadByte(ref span);
        ...
        {
            // Read a ushort.
            var raw = BinarySerializer.ReadUShort(ref span);
        ...
        public static string ReadString(ref ReadOnlySpan<byte> span)
        {
            ...
            var byteCount = (int)ReadPackedUInt(ref span);
